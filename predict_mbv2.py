...
def load_model():
    # loading imagenet pretrained model from torchvision best_model
    ...
    mbv2.load_state_dict(torch.load('/content/drive/MyDrive/Day-nightClassification/best_model/mbv2_best_model.pth', map_location=torch.device('cpu')))
